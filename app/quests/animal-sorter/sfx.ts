...
export function sfxCorrect() {
  play(523, "sine", 0.15);
  setTimeout(() => play(659, "sine", 0.15), 100);
  setTimeout(() => play(784, "sine", 0.3), 200);
}
...
export function sfxCelebrate() {
  [523, 659, 784, 1047].forEach((f, i) =>
    setTimeout(() => play(f, "sine", 0.2, 0.2), i * 120)
  );
}

export function sfxThink() {
  play(330, "triangle", 0.2, 0.15);
  setTimeout(() => play(370, "triangle", 0.25, 0.15), 200);
}
