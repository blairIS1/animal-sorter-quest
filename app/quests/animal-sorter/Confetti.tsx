...
export function Sparkle({ active }: { active: boolean }) {
  ...
  return (
    <span style={{ position: "relative", display: "inline-block" }}>
      ...
      <style>{`@keyframes sparkle-pop{0%{opacity:0;transform:scale(0)}50%{opacity:1;transform:scale(1.3)}100%{opacity:0;transform:scale(0.5) translateY(-10px)}}`}</style>
    </span>
  );
}
